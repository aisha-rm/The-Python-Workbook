...
Ta = float(input("Enter the air temperature in degrees Celsius. This must be less than or equal to 10. "))
V = float(input("Enter the wind speed in kilometers per hour. This must be greater than or equal to 4.8 kmph. "))
